...
@section('content')
    ...
    <div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
        <div class="flex flex-col gap-1">
            <p>Good day,</p>
            <h1 class="font-bold text-xl leading-[30px]">Explore RisaaSpace</h1>
        </div>
        <a href="#"
                    ...
                    <a href="{{ route('category.show', $category->slug) }}" class="card">
                        <div
                            ...
                            <div class="flex flex-col gap-[2px]">
                                ...
                                <p class="text-sm text-ngekos-grey">{{ $category->boardingHouses->count() }} properties</p>
                            </div>
                        </div>
                    </a>
                </div>
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        <img src="assets/images/icons/profile-2user.svg" class="w-5 h-5 flex shrink-0"
                                            alt="icon">
                                        <p class="text-sm text-ngekos-grey">1 Person</p>
                                    </div>
                                    <hr class="border-[#F1F2F6]">
    ...
    <section id="Cities" class="flex flex-col p-5 gap-4 bg-[#F5F6F8] mt-[30px]">
                ...
                <a href="{{ route('city.show', $city->slug) }}" class="card">
                    <div
                        ...
                        <div class="flex flex-col gap-[2px]">
                            ...
                            <p class="text-sm text-ngekos-grey">{{ $city->boardingHouses->count() }} properties</p>
                        </div>
                    </div>
                </a>
                @endforeach
        ...
        <section id="Best" class="flex flex-col gap-4 px-5 mt-[30px]">
            <div class="flex items-center justify-between">
                <h2 class="font-bold">All Great RisaaSpace</h2>
                <a href="#">
                    <div class="flex items-center gap-2">
                        <span>See all</span>
                        <img src="assets/images/icons/arrow-right.svg" class="w-6 h-6 flex shrink-0" alt="icon">
